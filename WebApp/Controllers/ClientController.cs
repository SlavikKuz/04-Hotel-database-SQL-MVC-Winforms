...
namespace HotelDb.WebUI.Controllers
{
    public class ClientController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClientFullName,Email,Tel,Address,Notes")] ClientModel clientModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,ClientFullName,Email,Tel,Address,Notes")] ClientModel clientModel)
        {
